...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 01 mars 2018 à 11:23
...
CREATE TABLE IF NOT EXISTS `dettes` (
  ...
  `utilisateur_id_endette` int(11) NOT NULL,
  PRIMARY KEY (`utilisateur_id`,`utilisateur_id_endette`),
  KEY `FK_Dettes_utilisateur_id_endette` (`utilisateur_id_endette`)
...
CREATE TABLE IF NOT EXISTS `paiements` (
  ...
  `utilisateur_id_payeur` int(11) NOT NULL,
  `utilisateur_id_receveur` int(11) NOT NULL,
  PRIMARY KEY (`paiement_id`),
  KEY `FK_Paiements_utilisateur_id_payeur` (`utilisateur_id_payeur`),
  KEY `FK_Paiements_utilisateur_id_receveur` (`utilisateur_id_receveur`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `dettes`
  ADD CONSTRAINT `FK_Dettes_utilisateur_id` FOREIGN KEY (`utilisateur_id`) REFERENCES `utilisateurs` (`utilisateur_id`),
  ADD CONSTRAINT `FK_Dettes_utilisateur_id_endette` FOREIGN KEY (`utilisateur_id_endette`) REFERENCES `utilisateurs` (`utilisateur_id`);
...
ALTER TABLE `paiements`
  ADD CONSTRAINT `FK_Paiements_utilisateur_id_payeur` FOREIGN KEY (`utilisateur_id_payeur`) REFERENCES `utilisateurs` (`utilisateur_id`),
  ADD CONSTRAINT `FK_Paiements_utilisateur_id_receveur` FOREIGN KEY (`utilisateur_id_receveur`) REFERENCES `utilisateurs` (`utilisateur_id`);
