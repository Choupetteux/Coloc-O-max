...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 29, 2018 at 10:14 AM
...
(3, 'ColocLLK', '5B Rue Edouard Vaillant', 'Reims', 'msg-SWQ-Nk1', 1);

-- --------------------------------------------------------

--
-- Table structure for table `contribuer`
--
...
CREATE TABLE IF NOT EXISTS `contribuer` (
  ...
  PRIMARY KEY (`facture_id`,`utilisateur_id`),
  KEY `FK_Contribuer_utilisateur_id` (`utilisateur_id`),
  KEY `FK_Contribuer_facture_id` (`facture_id`)
...
CREATE TABLE IF NOT EXISTS `factures` (
  ...
  `dateFacture` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
(94.58, '', 'Remboursement', '2018-03-25 13:28:06', 48, 4);
...
INSERT INTO `utilisateurs` (`utilisateur_id`, `nom`, `prenom`, `date_de_naissance`, `sexe`, `pseudo`, `passwd`, `colocation_id`, `avatar`, `LASTTIMESEEN`, `dateInscription`) VALUES
(1, 'Ribbi', 'Luigi', NULL, NULL, 'Luigito', '$2y$10$kCiZsf3hA9d9H2BzmYrkjuSd0sGhzlIe665mraLp5hN.W3bd32tEG', 3, 'placeholder.jpg', '2018-03-29 10:12:59', '2018-03-23 21:00:50'),
(2, 'Dielh', 'Lorenza', NULL, NULL, 'mikaiix', '$2y$10$tKa9BwXLyFAWQz5hYUxIb.hZSxzvjVXX8RhUA0f2ATpz7kspIPW3a', NULL, 'placeholder.jpg', NULL, '2018-03-23 21:00:50'),
(3, 'Pichu', 'Lily', '1998-02-19', 'F', 'Lilypichu', '$2y$10$9z/bt.TF/jCGKKL.X4FtB.02kJgJKm01MdniCfcVkpaaXl4NBn4Z.', 1, '4ed78a3f31bde0f919033a242cb38e5f8dcb91414f1c9f0bf0c58ca3b7b10eb8.jpeg', '2018-03-25 10:21:59', '2018-03-23 21:00:50'),
(4, 'Myster', 'Federico', '1998-02-19', 'M', 'Fedmyster', '$2y$10$mFuLX1IeyJL2eDJRiSqPzuDV0R/j4tTkRMTQeeVbVUbe5s/33ccOu', 1, '9883e2142f1d1bade0cbf9fa10c6f96ebd461e366df0c7c929e2d804accda74d.jpeg', '2018-03-25 13:29:04', '2018-03-23 21:00:50'),
(5, 'Marchand', 'Antoine', NULL, NULL, 'marchand', '$2y$10$6Kbov5YtI50MlS1qaFMzR.5Gh8.badAcUmqNU9YOKkA3AgbVoeRl.', 3, 'placeholder.jpg', '2018-03-25 13:22:09', '2018-03-23 21:00:50'),
(6, 'Imane', 'Poki', '1992-02-05', 'F', 'Pokimane', '$2y$10$FUEVDwCXrBol1oBrrQm/DOFhVZlZEw.UeJuXmQRyj.no/7BchOznW', 1, '043906d634f43bee460d079c0e168e2efcdca68507e00277dac2fbe178557825.jpeg', '2018-03-29 10:12:40', '2018-03-23 21:00:50'),
(7, 'Scar', 'Ra', NULL, NULL, 'Scarra', '$2y$10$hW.koNHM1BI2KoS.8Oe8luAFWJjFUE21pWV1BjCK8rplzKt8aAtV6', 1, '5ec7ca4cfeb70effc27c913ee7c26c84e7bcce0bac1155eb8b71a748dfd4cfdb.jpeg', '2018-03-21 10:12:12', '2018-03-23 21:00:50'),
(8, 'Chan', 'Rebecca', NULL, NULL, 'Pecca', '$2y$10$f9uTgwtXAClZIhCz8slGEuMrbIJ1mky.vaL5KKcPbBn2s1RQDdAa6', 1, '47187873db9b949200519a48bd969cc8271f872b363bb563adca3663aec34fc6.jpeg', '2018-03-21 09:55:13', '2018-03-23 21:00:50'),
(9, 'Chan', 'Chris', NULL, NULL, 'ChrisTo', '$2y$10$Gb0XsJ5nxvbA8Tr5D/cLMOIpe.JNrwVLrZfGIpOhcWywGDCwJFl.K', 1, '13704f8eba8a9388ce61d013fd54e60c04d4b8a87ac012d8b6bc0959838fd137.jpeg', NULL, '2018-03-23 21:00:50');
